...
namespace WebApp.Areas.TipoCategorias.Pages
{
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(MyRepository<TipoCategoria> repository, INotyfService notyfService, IFileUploadService fileUploadService)
        {
        ...
        public async Task<IActionResult> OnPost(IFormFile fileUpload)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    await _repository.AddAsync(TipoCategoria);
